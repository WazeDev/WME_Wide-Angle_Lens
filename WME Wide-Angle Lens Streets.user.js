...
(function (WMEWAL_Streets) {
    ...
    const updateText = '<ul><li>Option to include alt names in output</li>' +
        '<li>Find ramps with speed limits</li>' +
        '<li>Additional street attribute filters</li>' +
        '<li>Filter by created/modified timestamp</li>' +
        '<li>Filter by created by user</li>' +
        '<li>Filter by LG established or not</li>' +
        '<li>Report streets with no city</li></ul';
    ...
    function GetTab() {
        ...
        html += `<tr><td><input id='${ctlPrefix}SegmentLength' type='checkbox'/>` +
            ...
            `<input type='text' id='${ctlPrefix}SegmentLengthValue' class='wal-textbox' style='width: 40px'/> m` +
            "</td></tr>";
    ...
    function validateSettings() {
        ...
        if (s.SegmentLength) {
            ...
            if (isNaN(numVal) || val.trim() !== numVal.toString()) {
                addMessage("Invalid segment length");
            }
        }
    ...
    function ScanComplete() {
        ...
        if (streets.length === 0) {
            ...
            let includeLength = settings.SegmentLength;
            let lineArray;
            let columnArray;
            let w;
            let fileName;
